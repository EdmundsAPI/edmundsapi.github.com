...
Get incentives and rebates information for a car make ID.

### URL

	https://api.edmunds.com/v1/api/incentive/incentiverepository/findincentivesbymakeid?makeid={car make ID}&fmt=json&api_key={api key}
	...
	<body>
		...
		<script>
		  	window.sdkAsyncInit = function() {
				...
				// Fire the API call
				res.api('/v1/api/vehicle/incentive/incentiverepository/findincentivesbymakeid', options, success, fail);
