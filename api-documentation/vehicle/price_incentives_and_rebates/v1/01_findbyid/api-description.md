...
Get incentives and rebates information by ID.

### URL

	https://api.edmunds.com/v1/api/incentive/incentiverepository/findbyid?id={id}&fmt=json&api_key={api key}
	...
	<body>
		...
		<script>
		  	window.sdkAsyncInit = function() {
				...
				// Fire the API call
				res.api('/v1/api/vehicle/incentive/incentiverepository/findbyid', options, success, fail);
