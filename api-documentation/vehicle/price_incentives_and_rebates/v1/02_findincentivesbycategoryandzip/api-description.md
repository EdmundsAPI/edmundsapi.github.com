...
Get incentives and rebates that apply to a specific car category (see *static datasets* in the [Vehicle API overview](/api-documentation/vehicle/) for a list of available car or vehicle categories) and zip code.

### URL

	https://api.edmunds.com/v1/api/incentive/incentiverepository/findincentivesbycategoryandzipcode?category={car category}&zipcode={zip code}&fmt=json&api_key={api key}
