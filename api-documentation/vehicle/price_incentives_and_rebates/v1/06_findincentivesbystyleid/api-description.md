...
Get incentives and rebates information for a car style ID.

### URL

	https://api.edmunds.com/v1/api/incentive/incentiverepository/findincentivesbystyleid?styleid={style ID}&fmt=json&api_key={api key}
