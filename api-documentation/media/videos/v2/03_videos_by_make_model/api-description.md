...
Find Videos by Make/Model

### URL

    https://api.edmunds.com/api/media/v2/{make}/{model}/videos?api_key={api key}
    ...
    <body>
        ...
        <script>
            window.sdkAsyncInit = function() {
                ...
                // Fire the API call
                res.api('/api/media/v2/honda/civic/videos', options, success, fail);
